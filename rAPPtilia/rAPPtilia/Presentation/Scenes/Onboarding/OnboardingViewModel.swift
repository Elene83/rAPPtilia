class OnboardingViewModel {
    private let pages = [
        ...
        OnboardingPage(title: "", description: "Learn, pin, keep track and read up on one of the most important groups of animals in the ecosystem.", imageName: "liz", fontColorName: "AppDarkGreen", dotColorName: "AppLightGreen"),
